...
import { MessageSquare, Sparkles, Send } from 'lucide-react'; // ✅ 'send' removed — it doesn't exist!
...
const ChatInterface = () => {
  ...
  const scrollToBottom = () => {
    messagesEndRef.current?.scrollIntoView({ behavior: "smooth" }); // ✅ Fixed typo: scrollIntoview → scrollIntoView
  };
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      const errorMessage = {
        ...
        timestamp: new Date(), // ✅ Fixed: was 'new Data()'
      };

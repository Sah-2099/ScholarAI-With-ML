...
{isUploadModalOpen && (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
        <div className="relative w-full max-w-lg bh-white/95 backdrop-blur-xl border-slate-200/60 rounded-2xl shadow-slate-900/20 p-8">
          {/* Class button */}
          <button
          ...
          <div className="mb-6">
            ...
            <form onSubmit={handleUpload} className="space-y-5">
              ...
              <div className="space-y-2">
                <label className="block text-xs font-semiblod text-slate-700 uppercase tracking-wide">
                  Document Title
                </label>
                <input 
                type="text"
          ...
          >
            {uploading ? (
              <span className="flex items-center justify-center gap-2">
                <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full amimate-spin" />
                Uploading...
              </span>
            ) : (
              "Upload"
